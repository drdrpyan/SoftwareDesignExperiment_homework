...
public class Artcall extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "음악학과",
				"전화번호 : 051-510-1737", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "한국음악학과",
				"전화번호 : 051-510-1739", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "미술학과",
				"전화번호 : 051-510-1738", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "조형학과",
				"전화번호 : 051-510-7420", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "디자인학과",
				"전화번호 : 051-510-1736", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "무용학과",
				"전화번호 : 051-510-1740", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "예술문화영상학과",
				"전화번호 : 051-510-3755", R.drawable.telephone));
	}
