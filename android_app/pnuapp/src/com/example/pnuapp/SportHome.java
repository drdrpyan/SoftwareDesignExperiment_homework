...
public class SportHome extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "스포츠과학부",
				"http://sportscience.pusan.ac.kr/", R.drawable.ic_launcher));
