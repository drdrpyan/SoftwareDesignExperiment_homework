...
public class Businesscall extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "경영대학 전화1",
				"전화번호 : 051-510-7663", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "경영대학 전화2",
				"전화번호 : 051-510-7664", R.drawable.ic_launcher));
	}
