...
public class Medicinecall extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "약학대학 전화1",
				"전화번호 : 051-510-1684", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "약학대학 전화2",
				"전화번호 : 051-510-1685", R.drawable.telephone));
	}
