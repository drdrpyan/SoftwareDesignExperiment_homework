...
public class Economycall extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "무역학부",
				"전화번호 : 051-510-1657", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "경제학부",
				"전화번호 : 051-510-1658", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "관광컨벤션학과",
				"전화번호 : 051-510-1855", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "국제학부",
				"전화번호 : 051-510-1655", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "공공정책학부",
				"전화번호 : 051-510-7668", R.drawable.ic_launcher));
	}
