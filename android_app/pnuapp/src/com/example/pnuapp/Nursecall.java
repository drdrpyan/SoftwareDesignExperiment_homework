...
public class Nursecall extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "간호대학 전화1",
				"전화번호 : 051-510-8305", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "간호대학 전화2",
				"전화번호 : 051-510-8306", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "간호대학 전화3",
				"전화번호 : 051-510-8307", R.drawable.telephone));	
	}
