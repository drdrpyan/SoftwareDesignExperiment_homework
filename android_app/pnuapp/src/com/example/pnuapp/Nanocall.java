...
public class Nanocall extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "나노과학기술대학 부산",
				"전화번호 : 051-510-2795", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "나노과학기술대학 밀양",
				"전화번호 : 055-350-5270", R.drawable.ic_launcher));
	}
