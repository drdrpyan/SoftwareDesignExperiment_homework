...
public class Sosciencecall extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "행정학과",
				"전화번호 : 051-510-1557", R.drawable.telephone));
		adapter.add(new CData(getApplicationContext(), "정치외교학과",
				"전화번호 : 051-510-1558", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "사회복지학과",
				"전화번호 : 051-510-1559", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "사회학과",
				"전화번호 : 051-510-1560", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "심리학과",
				"전화번호 : 051-510-1561", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "문헌정보학과",
				"전화번호 : 051-510-1562", R.drawable.ic_launcher));
		adapter.add(new CData(getApplicationContext(), "신문방송학과",
				"전화번호 : 051-510-1563", R.drawable.ic_launcher));
	}
